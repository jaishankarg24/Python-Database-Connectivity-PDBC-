'''Write a python program to establish the connection with database and insert a
 record/data within the table'''
...
def insert_record():
	try:
		...
		sql_insert_query="""insert into `student`(`name`,`age`,`marks`) values('akash',22,70)""" 
